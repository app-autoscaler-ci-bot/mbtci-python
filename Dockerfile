...
# Automatic Python version updates via Renovate are currently disabled to keep the Python version in this Docker image aligned with the version used by the Cloud Foundry python-buildpack, which has received no new releases since 2025-07-02.
